    ...
    <Box sx={{ bgcolor: 'var(--color-background)', minHeight: '100vh' , width: '100%' }}>
      ...
      <HeroSection component="header">
        <Container maxWidth="md">
          ...
          <Typography variant="h5" sx={{ opacity: 0.9, fontWeight: 300, lineHeight: 1.6 }}>
      ...
      <Container maxWidth="lg" component="section" id="experience">
        ...
        <Stack spacing={3}>
          <StyledCard elevation={0}>
            <Typography variant="h5" color="var(--brand-deep-blue)" gutterBottom sx={{ fontWeight: 600 }}>
      ...
      <Container maxWidth="lg" component="section" id="skills">
        ...
        <Stack direction={{ xs: 'column', md: 'row' }} spacing={3} sx={{ mb: 6 }}>
          <StyledCard elevation={0} sx={{ flex: 1, bgcolor: '#ffffff' }}>
            <Typography variant="h6" gutterBottom color="var(--brand-orange)">Lenguajes</Typography>
            <Box component="ul" sx={{ pl: 2 }}>
          ...
          <StyledCard elevation={0} sx={{ flex: 1, bgcolor: '#ffffff' }}>
            <Typography variant="h6" gutterBottom color="var(--brand-orange)">Frameworks</Typography>
            <Box component="ul" sx={{ pl: 2 }}>
      ...
      <Box component="footer" sx={{ py: 6, textAlign: 'center', bgcolor: 'var(--brand-deep-blue)', color: 'white' }}>
        <Container maxWidth="lg">
          ...
          <Link 
            ...
            sx={{ color: 'var(--brand-light-orange)', textDecoration: 'none', fontWeight: 700 }}
          >
