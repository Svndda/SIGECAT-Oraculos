...
final class JobFunctionRepository extends Repository
{
   ...
   * when the declaration does not exist.
   *
   * @return array<string, mixed>|null
   */
   ...
   * FN_GET_CURRENT_STATUS database function. Null when the declaration has no
   * status rows.
   */
  public function getDeclarationStatus(string $declarationId): ?string
  {
